 ...
 * */
@Component
@Path("/v1.0/{lang}/methodologies/")
@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
public class V10Methodologies extends V10 {

    public V10Methodologies() {
        super();
    }
    ...
    public Response getGroups(@PathParam("lang") String lang,
        ...
        try {
            ...
            StreamingOutput stream = this.getFaostatapiCore().createOutputStream("methodologies", this.getO());
